...
#let secondary-color = rgb("#C48700")
#let tertiary-color = HEPLColors.bleu-hepl
#let text-color = rgb("#1C3B47")
...
#let university-theme(
  ...
  show: touying-slides.with(
    config-page(
      ...
      header-ascent: 0em,
      footer-descent: 0em,
      margin: (top: 1.75em, bottom: 0.6em, x: 0.5em),
    ),
    config-common(
      slide-fn: slide,
